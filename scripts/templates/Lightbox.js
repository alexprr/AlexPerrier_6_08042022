class Lightbox {
    ...
    manageEvents() {
        // Mouse Trigger
        document.querySelector(".lightbox__content .next").addEventListener("click", () => {
            this.next();
        });
        document.querySelector(".lightbox__content .prev").addEventListener("click", () => {
            this.prev();
        });
        document.querySelector(".lightbox__content .close").addEventListener("click", () => {
            this.close();
        });
